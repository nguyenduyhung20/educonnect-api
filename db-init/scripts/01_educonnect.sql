...
ALTER TABLE "account" ADD FOREIGN KEY ("id") REFERENCES "user" ("id");
...
ALTER TABLE "interact" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("id");
...
ALTER TABLE "admin" ADD FOREIGN KEY ("school_id") REFERENCES "school" ("id");

ALTER TABLE "student" ADD FOREIGN KEY ("id") REFERENCES "user" ("id");

ALTER TABLE "student" ADD FOREIGN KEY ("parent_id") REFERENCES "parent" ("id");

ALTER TABLE "parent" ADD FOREIGN KEY ("id") REFERENCES "user" ("id");

ALTER TABLE "teacher" ADD FOREIGN KEY ("id") REFERENCES "user" ("id");

ALTER TABLE "classroom" ADD FOREIGN KEY ("school_id") REFERENCES "school" ("id");

ALTER TABLE "learn" ADD FOREIGN KEY ("class_id") REFERENCES "classroom" ("id");

ALTER TABLE "learn" ADD FOREIGN KEY ("subject_id") REFERENCES "subject" ("id");

ALTER TABLE "document" ADD FOREIGN KEY ("subject_id") REFERENCES "subject" ("id");

ALTER TABLE "document" ADD FOREIGN KEY ("teacher_id") REFERENCES "teacher" ("id");

ALTER TABLE "transcript" ADD FOREIGN KEY ("student_id") REFERENCES "student" ("id");

ALTER TABLE "transcript" ADD FOREIGN KEY ("subject_id") REFERENCES "subject" ("id");

ALTER TABLE "teaching" ADD FOREIGN KEY ("subject_id") REFERENCES "subject" ("id");

ALTER TABLE "teaching" ADD FOREIGN KEY ("teacher_id") REFERENCES "teacher" ("id");

ALTER TABLE "of" ADD FOREIGN KEY ("student_id") REFERENCES "student" ("id");

ALTER TABLE "of" ADD FOREIGN KEY ("class_id") REFERENCES "classroom" ("id");