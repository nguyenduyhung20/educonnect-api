...
import { handleSummarizePost } from './controllers/summarizePost.controller';
...
cron.schedule('*/5 * * * * *', async () => {
  ...
  const result = await handleSummarizePost({
    text: `Giáng sinh vừa rồi, tôi dùng phiếu quà tặng của Công đoàn để mua cho con gái chiếc xe đạp như mong ước. Còn phiếu quà tặng năm trước, tôi đã sử dụng vào dịp giảm giá hè vừa qua để mua giày cho các cháu.
